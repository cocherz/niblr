    ...
    return (
        <div className="footer-copy-container noselect">
                ...
                <p>
                  ...
                  day. All prices are inclusive of VAT and a discretionary gratuity of 12.5% is added to the total bill and divided fairly between the team and independently from the business.{" "}
                </p>
        </div>
    );
};
